...
namespace Xcb.Net.RLP
{
    ...
    ///         RLP is the main encoding method used to serialize objects in Coreblockchain. The
    ...
    ///         Coreblockchain the standard is that integers are represented in big endian binary
