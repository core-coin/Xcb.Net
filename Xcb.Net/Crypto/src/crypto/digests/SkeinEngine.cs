...
namespace Org.BouncyCastle.Extended.Crypto.Digests
{
    ...
    /// sizes, based on the <see cref="Org.BouncyCastle.Extended.Crypto.Engines.ThreefishEngine">Threefish</see> tweakable block cipher.
    /// </summary>
    /// <remarks>
    ...
    /// <p/>
    /// This implementation is the basis for <see cref="Org.BouncyCastle.Extended.Crypto.Digests.SkeinDigest"/> and <see cref="Org.BouncyCastle.Extended.Crypto.Macs.SkeinMac"/>, implementing the
    /// parameter based configuration system that allows Skein to be adapted to multiple applications. <br/>
    /// Initialising the engine with <see cref="Org.BouncyCastle.Extended.Crypto.Parameters.SkeinParameters"/> allows standard and arbitrary parameters to
    ...
    /// </ul>
    /// </remarks>
    /// <seealso cref="Org.BouncyCastle.Extended.Crypto.Parameters.SkeinParameters"/>
        ...
        : IMemoable
    {
        ...
        /// <summary>
        /// Initialises the Skein engine with the provided parameters. See <see cref="Org.BouncyCastle.Extended.Crypto.Parameters.SkeinParameters"/> for
