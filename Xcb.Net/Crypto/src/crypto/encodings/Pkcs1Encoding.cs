...
namespace Org.BouncyCastle.Extended.Crypto.Encodings
{
    /**
    ...
    */
        ...
        : IAsymmetricBlockCipher
    {
         ...
         * work with one of these set the system property Org.BouncyCastle.Extended.Pkcs1.Strict to false.
         */
        public const string StrictLengthEnabledProperty = "Org.BouncyCastle.Extended.Pkcs1.Strict";
