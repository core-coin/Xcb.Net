...
namespace Org.BouncyCastle.Extended.Crypto.Macs
{
	...
	/// based on the <see cref="Org.BouncyCastle.Extended.Crypto.Engines.ThreefishEngine">Threefish</see> tweakable block cipher.
	/// </summary>
	/// <remarks>
	...
	/// </remarks>
	/// <seealso cref="Org.BouncyCastle.Extended.Crypto.Digests.SkeinEngine"/>
		...
		: IMac
	{
		...
		/// </summary>
		/// See <see cref="Org.BouncyCastle.Extended.Crypto.Parameters.SkeinParameters"></see> for details on the parameterisation of the Skein hash function.
